...
public class DispatchRecordController {
    ...
    public ApiResponse<DispatchPublicDetailVO> publicDetail(@PathVariable String orderId) {
        return ApiResponse.ok(extendedBusinessService.publicDispatchDetail(orderId));
    }
}
